   ...
   */
   ...
   private class PutScanner extends KeyValueScanFixture implements InternalScanner {
     ...
     PutScanner(Scan scan) {
       ...
       matcher= new ScanQueryMatcher(scan, null, null, HConstants.FOREVER, KeyValue.KEY_COMPARATOR, scan.getMaxVersions());
        }
